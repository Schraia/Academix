...
@section('content')
    ...
    <style>
        ...
        .banner-preview-wrap { margin-top: 0.5rem; max-height: 320px; overflow: hidden; border-radius: 12px; border: 1px solid #e5e7eb; background: #f9fafb; }
        .banner-preview-wrap img { display: block; max-width: 100%; }
