...
@section('title', $course->title . ' - Edit Announcement')
...
@section('content')
    ...
    <div class="form-card">
        <form action="{{ route('courses.announcements.update', [$course, $announcement]) }}" method="POST" enctype="multipart/form-data">
            @csrf
            ...
            <div class="form-group">
                ...
                @if($announcement->image_path)
                    <p style="font-size: 0.875rem; color: #6b7280; margin-bottom: 0.25rem;">Current image is set. Upload a new image to replace it.</p>
                @endif
